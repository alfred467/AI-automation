          ...
          <div className="grid lg:grid-cols-[40%_1fr] gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 to-cyan-100 border border-blue-200 mb-4">
                <span className="text-blue-700 font-semibold text-sm uppercase tracking-wide">Xovix Labs</span>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                  Xovix AI handles all your WhatsApp, Messenger, and Instagram DM conversations automatically.
                      ...
                      <div className="bg-[#0d1418] rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-140px)] lg:h-[calc(100%-200px)] overflow-y-auto scrollbar-hide space-y-2 lg:space-y-3">
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-2 sm:p-3 lg:p-4 border border-slate-700/50">
                          <div className="flex items-center gap-2 mb-2 lg:mb-3">
                            <svg
                              className="w-3 h-3 lg:w-4 lg:h-4 text-cyan-400"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path
                          ...
                          <div className="space-y-2 lg:space-y-3 text-[8px] sm:text-[9px] lg:text-xs">
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              <div className="text-cyan-400 font-semibold mb-0.5">Xovix AI</div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    ...
                    website, phone, and social media. Xovix AI manages bookings, answers parts questions, and
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Xovix AI automatically schedules service appointments and sends confirmations across all
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Stop wasting time on repetitive questions. Xovix AI instantly answers common inquiries about
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Xovix AI responds to 50+ common questions about NCT, mileage, trade-ins, and pricing
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Stop answering the same questions repeatedly - let Xovix AI handle the tire kickers
                      </p>
                    </div>
